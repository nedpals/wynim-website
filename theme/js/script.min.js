        ...
        jQuery2.each({ scrollLeft: "pageXOffset", scrollTop: "pageYOffset" }, function(method, prop) {
          ...
          jQuery2.fn[method] = function(val) {
            return access(this, function(elem, method2, val2) {
              ...
              if (win3) {
                win3.scrollTo(
                  !top ? val2 : win3.pageXOffset,
                  top ? val2 : win3.pageYOffset
                );
              } else {
                elem[method2] = val2;
              }
...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  // javascript/script.js
  function toggleNavMenu(menuId, data2) {
    const idx = data2.menuIds.indexOf(menuId);
    if (idx === -1) {
      showNavMenu(menuId, data2);
    } else {
      hideNavMenu(menuId, data2);
    }
  }
  function showNavMenu(menuId, data2) {
    if (data2.menuIds.includes(menuId)) {
      return;
    }
    data2.menuIds.push(menuId);
  }
  function hideNavMenu(menuId, data2) {
    const idx = data2.menuIds.indexOf(menuId);
    if (idx === -1) {
      return;
    }
    data2.menuIds.splice(idx, data2.menuIds.length - idx);
  }
