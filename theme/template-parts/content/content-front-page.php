<div class="max-w-wide w-full mx-auto">
	<section class="px-3 xl:px-0 xl:-mx-12">
		<div class="w-full flex text-white bg-slate-500 px-12 py-32 rounded-tl-[8rem] rounded-br-[8rem] rounded-bl-lg rounded-tr-lg">
			<div class="w-1/2">
				<h1 class="text-7xl font-extrabold">Study, work, and live in Canada</h1>
	...
	<section class="py-24">
		...
		<div class="flex px-2 -mx-4">
			<div class="w-1/3 p-4 flex">
				<div class="h-16 w-16 bg-slate-200"></div>
	...
	<section class="flex flex-col">
		<div class="w-full text-center pb-12 space-y-8 flex flex-col items-center">
			<h2 class="text-4xl font-extrabold">Browse Programs & Universities</h2>

			<div class="group w-2/3 flex border rounded-full border-slate-100 focus-within:outline outline-1 outline-primary-400">
				<button class="button is-secondary rounded-r-none">
					<span>Programs</span>
				...
				<div class="flex-1 bg-white rounded-r-full flex items-stretch">
					<input type="text" placeholder="Search for programs" class="flex-1 pl-6 pr-[3rem] py-3 bg-transparent border-0 focus:outline-none" />
		...
		<a href="#" class="button is-secondary self-center mt-20">
	...
	<section class="flex shadow-2xl rounded-2xl">
		<div class="w-1/3 bg-secondary-500 rounded-l-2xl p-12 flex flex-col justify-between">
			<div class="space-y-2">
				<h3 class="text-3xl text-primary-500 font-bold">Contact Us</h3>
			...
			<div class="flex flex-col space-y-4">
				<div class="flex space-x-4">
					...
					<span class="flex-1">+1012 3456 789</span>
				</div>
				...
				<div class="flex space-x-4">
					...
					<span class="flex-1">demo@gmail.com</span>
				</div>
				...
				<div class="flex space-x-4">
					...
					<span class="flex-1">132 Dartmouth Street Boston, Massachusetts 02156 United States</span>
				</div>
			</div>
		</div>

		<div class="w-2/3 bg-white rounded-r-2xl p-12 flex flex-col">
			<div class="flex flex-wrap -mx-4">
				<div class="w-1/2 p-4 flex flex-col space-y-2">
					<label class="font-semibold" for="first_name">First Name</label>
					<input type="text" id="first_name" placeholder="Juan" class="py-4 border-b-2 focus:outline-none focus:border-primary-500 focus:bg-slate-50/40 transition-colors" />
				</div>
				...
				<div class="w-1/2 p-4 flex flex-col space-y-2">
					...
					<input type="text" id="email" placeholder="example@example.com" class="py-4 border-b-2 focus:outline-none focus:border-primary-500 focus:bg-slate-50/40 transition-colors" />
				</div>

				<div class="w-1/2 p-4 flex flex-col space-y-2">
					<label class="font-semibold" for="phone">Phone Number</label>
					<input type="text" id="phone" placeholder="+639xxxxx" class="py-4 border-b-2 focus:outline-none focus:border-primary-500 focus:bg-slate-50/40 transition-colors" />
				</div>

				<div class="w-full p-4 flex flex-col space-y-2">
					<span class="font-semibold">Preferred communication method</span>
				...
				<div class="w-full p-4 flex flex-col space-y-2">
					...
					<textarea name="message" placeholder="Write your inquiry" rows={10} class="py-4 border-b-2 focus:outline-none focus:border-primary-500 focus:bg-slate-50/40 transition-colors"></textarea>
				</div>
			</div>
